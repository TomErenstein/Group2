...
Game.prototype = {
    ...
    */
    ...
    preload: function () {
        ...
        //game.load.image('cards',    'assets/images/cards8.png');
        //game.load.spritesheet("cards", "assets/images/cards8.png", 71, 95, 55);
          //game.load.spritesheet('cards',    'assets/images/cards8.png');      
    },
    create: function () {
    this.stage.disableVisibilityChange = false;
    console.log("------------START--------------")   //log
    game.add.sprite(0, 0, 'stars');         //insert background
        
    //Highscore text
    highScoreText1 = this.game.add.text(1050, 560, 'High  ', {font: '25px Arial',fill:'white'});
    highScoreText2 = this.game.add.text(1050, 580, 'score ', {font: '25px Arial',fill:'white'});
    ...
    var score = 0;
    var highscore = 0;
    var scoreText, highScoreText1, highScoreText2;
    ...
    //CREATE cards and give them values
            ...
            if (!chosen1){
                if (card.parent == player1Cards) {
                    ...
                    */
                    ...
                    cardchosenname = card;
                    console.log("Chosen card: " + cardchosenname);   //log
                    round++;                        //next round
                }
            }
        }
    ...
    round=1;
        ...
        var calcScore= function() {
            ...
            console.log("playerValue12: " +playerValue13 +" playerValue13: "+ playerValue13);
            ...
            console.log("vD1: "+(value1diff/10)+"vD2: "+(value2diff/10)+"vD3: "+(value3diff/10));
            score = Math.abs((value1diff + value2diff + value3diff)/10);
            console.log("SCORE: "+ score);   //log
        ...
        if (card != null){
            if (round<=2){ 
                if (chosen1){
                    ...
                    console.log("BASE cards");       //log
                    console.log(base.children);
                    console.log("Player1 Cards");
                    console.log(player1Cards.children); 

                    cardswappedname = card;
                    console.log("Swapped card: " + cardswappedname);    //log
            ...
            else if (round==3) {    //END game
                player1Cards.add(card);
                base.add(selected1.removeChildAt(0));
                selected1.remove(card);

                updateCards();   //update and calc score
                calcScore();

                endHighscore.setText("Your Highscore is: " + score);
                console.log("GAMEOVER");    

                player1Cards.inputEnableChildren = false;
    ...
    //MOVING all children with delay and keep them spread out
    ...
    var revealCard= function() {  //2 cards get revealed  (gets called twice)
        var card = deck.removeChildAt(0);   
        base.add(card);     //add 2 cards to base group
        updateCards();
    };
    
    var updateCards= function() {   //Call this after each move
    ...
    //enable input and look for clicks
    ...
    //MOVE cards at start to base positions
    ...
    for (var i = 0; i < deck.children.length; i++) {
        ...
        game.add.tween(child).to({ x: deckcardsX, y: deckcardsY }, 0, Phaser.Easing.Quadratic.Out, true, i*deckcardsdelay);  //0, 0
    }
}     //END OF CREATE
...
//LOAD cards
   /*     
function preload() {      
    //game.load.spritesheet("cards", "./images/cardss.png", 170, 220, 140);       //width. height.   
    //game.load.spritesheet("cards", "./images/cards.png", 615, 810, 520);
    //game.load.spritesheet("cards", "./images/cardss.png", 61.5, 81, 52); 
    //game.load.spritesheet("cards", "./images/cards.png", 170, 220, 140);
    //game.load.spritesheet("cards", "./images/test3.png", 71, 95, 55);
    game.load.spritesheet("cards", "./images/test3.png", 71, 95, 55);
}
*/
